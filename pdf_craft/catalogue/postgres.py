...
_MIGRATIONS = (
    ...
    Migration(
        9,
        "external_and_user_ratings",
        """
        CREATE TABLE catalogue_external_ratings (
            id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        ...
        CREATE TABLE catalogue_user_ratings (
            id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            work_id BIGINT NOT NULL REFERENCES catalogue_works(id) ON DELETE CASCADE,
        ...
        CREATE INDEX idx_catalogue_external_ratings_edition
            ON catalogue_external_ratings(edition_id, provider, observed_at DESC);
        CREATE INDEX idx_catalogue_external_ratings_provider
            ON catalogue_external_ratings(provider, external_id);
        CREATE INDEX idx_catalogue_user_ratings_work
